...
def parse_opt(known=False):
    ...
    parser.add_argument('--t_weights', type=str, default='yolov5l.pt', help='teacher model weights path')
    parser.add_argument('--dist_loss', type=str, default='l2', help='distillation loss type: kl/l2')
